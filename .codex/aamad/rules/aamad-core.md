...
## State and Output
- Outputs follow template headings exactly using `.codex/aamad/templates/`. Do not wrap machine-parsed blocks in code fences if templates require raw content.
...
- The active runtime adapter (selected via `AAMAD_TARGET_RUNTIME`) defines conventions for the generated application in Phase 2: runtime setup, module or agent declaration style where applicable, tool/MCP binding, observability, and execution controls.
